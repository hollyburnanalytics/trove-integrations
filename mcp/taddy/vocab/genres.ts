/**
 * Taddy's podcast genres — the 110 `PODCASTSERIES_*` members of the upstream
 * `Genre` enum, transcribed from https://ax0.taddy.org/docs/schema.graphql.
 *
 * The comic genres that share that enum are omitted: no tool here can reach
 * them, and offering them as valid input would only produce empty results.
 */
