...
export default defineSource({
  ...
  status: 'implemented',
  needsBrowser: false,
  egress: ['www.quantamagazine.org'],
  historyReach: {
    kind: 'window',
    note: 'This source reads an index page, so it reaches back as far as that page lists and no further.',
  },
  egressNote:
    'The feed and every article page it links are on www.quantamagazine.org — this source fetches the page, not just the feed entry.',
  async sync(context) {
